...
RBT Locks are fixed-term commitment instruments issued as ERC-721 NFTs. Holders commit their RBT for a set period, and at the end of the period the committed RBT is returned along with additional RBT minted by the protocol.
