...
<Steps>
  <Step title="Choose Term">Select your lockup duration (up to 52 weeks)</Step>
  <Step title="Deposit RBT">Lock your RBT into the Note contract</Step>
  <Step title="Receive NFT">Get an ERC-721 representing your position</Step>
...
<Note>
  Your yield is **guaranteed and known upfront**. No variable APYs or market
  dependencies.
</Note>
...
<Tip>
  Longer terms earn disproportionately higher yields due to the quadratic bonus
  component.
</Tip>
...
<Warning>
  RBT Notes yield is funded by a **capped rewards pool**. When the pool is fully
  allocated, new Note deposits close until the pool refills.
</Warning>
